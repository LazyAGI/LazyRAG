...
def get_eval_queue(eval_name: str, *, case_id: str = '', dataset_name: str = '',
                   base_dir: str | Path, target_chat_url: str = '',
                   max_workers: int = 8,
    ...
    with ThreadPoolExecutor(max_workers=workers) as executor:
        futures = {
            executor.submit(_build_eval_item, {**case, '_order': i},
                            target_chat_url, dataset_name, filters or {}): case
...
def _build_eval_item(
    case: dict, target_chat_url: str, dataset_name: str,
