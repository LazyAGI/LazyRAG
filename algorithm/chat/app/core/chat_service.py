...
async def handle_chat(query: str, history: Optional[List[Dict[str, Any]]],
                      ...
                      priority: Optional[int], prompt_template: Optional[str],
                      available_tools: Optional[List[str]], available_skills: Optional[List[str]],
                      skill_fs_url: Optional[str], memory: Optional[str],
