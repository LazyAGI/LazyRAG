...
def _build_skill_prompt(
    ...
    return (
        ...
        '\n'
        'Language policy: write the generated content in the language implied by the existing content and the user input. '
        ...
        '- If suggestions or user_instruct expands, narrows, or otherwise changes the applicable scope, trigger scenario, '
        ...
        '\n'
        'Body requirements:\n'
        '- The body must be an abstract SOP: steps, decision criteria, checklists, general rules, and output requirements.\n'
        ...
        '- Recommended sections include applicable conditions, operating steps, judgment and validation, common pitfalls, '
        'and output requirements. Trim sections as needed.\n'
        '\n'
        'Length control:\n'
        '- Keep the full SKILL.md file, including frontmatter, within 2000 words or the equivalent length. Be concise.\n'
        '\n'
...
def _build_memory_prompt(
    ...
    return (
        ...
        '\n'
        'Content boundaries:\n'
        '- Record only reusable experience. Do not store one-off logs, pure emotional expression, or irrelevant small talk.\n'
        '- Do not store user profile information here, such as identity, role, long-term preferences, or communication style; '
        ...
        '- Deduplicate and consolidate during merging: combine identical or similar experiences into a more accurate statement.\n'
...
def _build_user_preference_prompt(
    ...
    return (
        ...
        '- Do not write chat transcripts or logs. Organize the content as profile entries that the agent can read quickly.\n'
        '\n'
        'Writing and merging rules:\n'
        '- Output the full plain text content. Simple markdown grouping or lists are allowed; do not use YAML frontmatter.\n'
        '- Update rather than append the same profile dimension. New preferences override old ones; if there is a conflict, '
        'user_instruct has the highest priority.\n'
        '- Group by dimension when useful, such as identity, output preferences, language and tone, taboos, and other conventions.\n'
        '- Keep the language concise and neutral. Do not add personified comments; only state factual user profile entries.\n'
        '\n'
        f'{_format_retry_note(previous_error)}'
        f'{_format_inputs_block(content, suggestions, user_instruct)}'
        f'{_COMMON_OUTPUT_SPEC}'
