...
_MEMORY_REVIEW_PROMPT = (
    ...
    "Write to memory(target='memory') for: reusable experience, environment facts, "
    "workflow conventions, lessons learned, project-level conventions, tool usage patterns.\n"
    "Write to memory(target='user') for: user identity/role, communication tone, "
    ...
    "- Merge new findings INTO the existing content; do NOT discard and rewrite from scratch.\n"
