...
MEMORY_GUIDANCE = (
    ...
    "For multi-step reusable workflows, troubleshooting procedures, lessons learned, "
    "tool usage patterns, or task-specific conventions, prefer skill_manage instead of memory. "
...
_MEMORY_REVIEW_PROMPT = (
    ...
    "language preference, output format, level of detail, taboos, or default workflow preferences "
    "that are stable across many tasks.\n"
