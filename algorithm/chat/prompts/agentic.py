...
_MEMORY_REVIEW_PROMPT = (
    ...
    "minor passing remarks, or anything the user wouldn't need recalled later. "
    ...
    "Submit suggestions via memory(target='memory', suggestions=[...]) for: reusable experience, environment facts, "
    "workflow conventions, lessons learned, project-level conventions, tool usage patterns.\n"
    "Submit suggestions via memory(target='user', suggestions=[...]) for: user identity/role, communication tone, "
    "language preference, output format, level of detail, taboos, default workflow preferences.\n"
    ...
    "If nothing is worth saving or updating, reply exactly: Nothing to save."
)
